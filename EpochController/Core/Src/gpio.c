...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LED_Pin|TEST_M1_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = LED_Pin|TEST_M0_Pin|TEST_M1_Pin;
  ...
  GPIO_InitStruct.Pin = EBYTE_M0_Pin|EBYTE_M1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
